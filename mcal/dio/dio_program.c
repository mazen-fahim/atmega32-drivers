...
u8 DIO_U8GetPinValue(u8 Copy_U8PortNum, u8 Copy_U8PinNum) {
  ...
  switch (Copy_U8PortNum) {
  case 0:
    LOC_U8RetValue = GET_BIT(PINA_REG, Copy_U8PinNum);
    break;
  case 1:
    LOC_U8RetValue = GET_BIT(PINB_REG, Copy_U8PinNum);
    break;
  case 2:
    LOC_U8RetValue = GET_BIT(PINC_REG, Copy_U8PinNum);
    break;
  case 3:
    LOC_U8RetValue = GET_BIT(PIND_REG, Copy_U8PinNum);
    break;
  }
...
void DIO_VoidTogglePinValue(u8 Copy_U8PortNum, u8 Copy_U8PinNum) {
  switch (Copy_U8PortNum) {
  case 0:
    TOGGLE_BIT(PORTA_REG, Copy_U8PinNum);
    break;
  case 1:
    TOGGLE_BIT(PORTB_REG, Copy_U8PinNum);
    break;
  case 2:
    TOGGLE_BIT(PORTC_REG, Copy_U8PinNum);
    break;
  case 3:
    TOGGLE_BIT(PORTD_REG, Copy_U8PinNum);
    break;
  }
}
